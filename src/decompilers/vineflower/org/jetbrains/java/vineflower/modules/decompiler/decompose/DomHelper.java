...
package org.jetbrains.java.vineflower.modules.decompiler.decompose;

import org.jetbrains.java.vineflower.api.plugin.GraphParser;
...
import org.jetbrains.java.vineflower.main.rels.MethodProcessor;
//import org.jetbrains.java.decompiler.modules.decompiler.*;
import org.jetbrains.java.vineflower.modules.decompiler.LabelHelper;
import org.jetbrains.java.vineflower.modules.decompiler.SequenceHelper;
import org.jetbrains.java.vineflower.modules.decompiler.StatEdge;
import org.jetbrains.java.vineflower.modules.decompiler.deobfuscator.IrreducibleCFGDeobfuscator;
//import org.jetbrains.java.decompiler.modules.decompiler.stats.*;
import org.jetbrains.java.vineflower.modules.decompiler.stats.*;
import org.jetbrains.java.vineflower.modules.decompiler.stats.Statement.EdgeDirection;
...
import org.jetbrains.java.vineflower.util.collections.fixed.FastFixedSet;
import org.jetbrains.java.vineflower.util.collections.fixed.FastFixedSetFactory;
...
public final class DomHelper implements GraphParser {
  ...
  private static boolean processStatement(
    Statement general,
    RootStatement root,
          ...
          while (true) {
            ...
            if (stat != null) {
              ...
              if (complete) {
                ...
                tracer.error(general, "General statement processing failed! " + stat);
                // Statement processing failed in an inner subgraph, so we give up here too
                return false;
              }

              tracer.success(general, "General statement processing success " + stat);
    ...
    if (forceall) {
      ...
      for (Statement st : lstAll) {
        ...
        if (set != null) {
          ...
          vbPost.addWithKey(element, st.id); // FIXME: sort order!!
        }
      }
